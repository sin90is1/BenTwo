...
#include "OculusInteractionSamples/UIsdkResetTransforms.h"

 // Sets default values for this component's properties
UUIsdkResetTransforms::UUIsdkResetTransforms()
{
    PrimaryComponentTick.bCanEverTick = true;
}

void UUIsdkResetTransforms::BeginPlay()
{
    Super::BeginPlay();
...
void UUIsdkResetTransforms::TickComponent(
    float DeltaTime,
    ELevelTick TickType,
...
void UUIsdkResetTransforms::ResetTransforms()
{
